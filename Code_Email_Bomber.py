...
def banner():
    ...
    time.sleep(0.15)
    print('                                                                                                        ')
    print('                  oooooooo           oooo        *******         ********    oooooooo      ooooooooooo    oooooooooo')
    time.sleep(0.15)
    print('                  oooo   ooo      ooo    ooo     ***** ***      *** *****    oooo   ooo    ooo            oooo    ooo')
    time.sleep(0.15)
    print('                  oooo    ooo    ooo      ooo    *****  ***    ***  *****    oooo    ooo   ooo            oooo     oo')
    time.sleep(0.15)
    print('                  oooo    ooo   ooo        ooo   *****   ***  ***   *****    oooo    ooo   ooo            oooo    oo')
    time.sleep(0.15)
    print('                  oooo   ooo    oo          oo   *****    ******    *****    oooo   ooo    ooo            oooo   oo')
    time.sleep(0.15)
    print('                  ooooooooo     oo          oo   *****              *****    ooooooooo     oooooooooo     oooo  oo')
    time.sleep(0.15)
    print('                  oooo   ooo    oo          oo   *****              *****    oooo   ooo    ooo            ooooooo')
    time.sleep(0.15)
    print('                  oooo    ooo    ooo      ooo    *****              *****    oooo    ooo   ooo            oooo ooo')
    time.sleep(0.15)
    print('                  o o     o o     o o    o o     * * *              * * *    o o     o o   o o            o oo  o o')
    time.sleep(0.15)
    print('                  o o   o o        o o o o       * * *              * * *    o o   o o     o o            o o    o o')
    time.sleep(0.15)
    print('                  o   o oo           o  o        *   *              *   *    o   o  oo     o o o o o o    o o     o o')
